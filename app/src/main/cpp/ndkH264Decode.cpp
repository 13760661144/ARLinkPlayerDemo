...
Java_com_example_ning_arlinkplayerdemo_MainActivity_startVideoStream1(JNIEnv *env, jobject instance,
                                                                      jobject id, jobject surface) {
    ...
    jclass wc = env->FindClass("com/example/ning/arlinkplayerdemo/MainActivity");
    if (wc == 0) {
